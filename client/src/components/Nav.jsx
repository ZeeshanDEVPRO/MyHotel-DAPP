  ...
  return (
    <div className='bg-white flex justify-between font-noto-sans-<uniquifier> font-sans p-[1.5vh] fixed top-0 left-0 w-full z-50' style={{ boxShadow: '0px 4px 6px -1px rgba(0, 0, 0, 0.1), 0px 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
      ...
      <div className='flex items-center gap-4'>
        {
          !account ?
            <button className='hidden sm:inline-block sm:text-lg md:text-xl p-[1vh] md:p-[2vh] md:py-[1.5vh] bg-green-600 hover:bg-green-700 font-medium text-white rounded-md md:rounded-lg shadow-2xl' onClick={() => connectContract()}>Connect Account</button>
            :
            <button className='hidden sm:inline-block sm:text-lg md:text-xl p-[1vh] md:p-[2vh] md:py-[1.5vh] bg-green-600 hover:bg-green-700 font-medium text-white rounded-md md:rounded-lg shadow-2xl'>Connected</button>
        }
      </div>
    </div>
  )
